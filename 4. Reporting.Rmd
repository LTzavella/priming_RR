...
write.csv(mega1, here("reporting", "mega1.csv"), row.names = FALSE)
write.csv(mega2, here("reporting", "mega2.csv"), row.names = FALSE)

# For reporting purposes we don't need priming measures again so exclude from file
write.csv(subset(mega1, select = c(1:53, 61:79)), here("reporting", "mega_lab.csv"), row.names = FALSE)
write.csv(subset(mega2, select = c(1:53, 61:79)), here("reporting", "mega_onl.csv"), row.names = FALSE)
```
